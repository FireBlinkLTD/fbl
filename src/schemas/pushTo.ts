...
const FBL_PUSH_TO_SCHEMA = Joi.alternatives(FBL_PUSH_TO_OBJECT_SCHEMA, FBL_PUSH_TO_STRING_SCHEMA);

export { FBL_PUSH_TO_OBJECT_SCHEMA, FBL_PUSH_TO_STRING_SCHEMA, FBL_PUSH_TO_SCHEMA };
