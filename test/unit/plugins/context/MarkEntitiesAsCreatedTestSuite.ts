...
import {MarkEntitiesAsCreated} from '../../../../src/plugins/context/MarkEntitiesAsCreated';
...
@suite
class MarkEntitiesAsCreatedTestSuite {

    @test()
    async failValidation(): Promise<void> {
        const actionHandler = new MarkEntitiesAsCreated();
