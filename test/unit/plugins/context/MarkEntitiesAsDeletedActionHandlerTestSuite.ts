...
import {MarkEntitiesAsDeletedActionHandler} from '../../../../src/plugins/context/MarkEntitiesAsDeletedActionHandler';
...
@suite
class MarkEntitiesAsDeletedActionHandlerTestSuite {

    @test()
    async failValidation(): Promise<void> {
        const actionHandler = new MarkEntitiesAsDeletedActionHandler();
