...
import { MarkEntitiesAsRegisteredActionHandler } from '../../../../src/plugins/context/MarkEntitiesAsRegisteredActionHandler';
...
@suite
class MarkEntitiesAsRegisteredActionHandlerTestSuite {
    @test()
    async failValidation(): Promise<void> {
        const actionHandler = new MarkEntitiesAsRegisteredActionHandler();
